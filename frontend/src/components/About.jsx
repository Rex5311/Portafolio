        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
              Soy Juan Esteban Agudelo Carmona, estudiante de sexto semestre de
              Desarrollo de Software en la Universidad del Valle, Colombia. Mi
              pasión es crear soluciones web completas y eficientes.
            </p>
            <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
              Me especializo principalmente en Python con experiencia en
              frameworks como FastAPI y Express. También tengo conocimientos en
              desarrollo frontend con React y trabajo activamente con
              inteligencia artificial. Me encanta aprender nuevas tecnologías y
              aplicarlas en proyectos reales que generen impacto.
            </p>
            <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
              Actualmente busco oportunidades de prácticas o posiciones junior
              donde pueda aplicar mis conocimientos y seguir creciendo
              profesionalmente en el desarrollo de software.
            </p>
